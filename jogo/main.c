...
}// essa funcao pega uma coordenada alphanumerica como de xadrez e retorna a posicao "i" na matriz
...
}// essa funcao pega uma coordenada alphanumerica como de xadrez e retorna a posicao "j" na matriz
int main()
{
    //criar tabuleiro
    char tabuleiro[8][8];
